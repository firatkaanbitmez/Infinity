        ...
        private void listView1_MouseClick(object sender, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.Right)
            {
                if (listView1.FocusedItem != null && listView1.FocusedItem.Bounds.Contains(e.Location) == true)
                {
                    ...
                    MenuItem cashMenuItem = new MenuItem("Silent Install");
                    ...
                    MenuItem delMenuItem = new MenuItem("Add MyList");
            ...
            if (this.listView1.SelectedItems.Count > 0)
            {
                ...
                if (dialogResult == DialogResult.Yes)
                {
                    foreach (ListViewItem eachItem in listView1.SelectedItems)
                    {
                        ...
                        sourcename = listView1.SelectedItems[0].SubItems[4].Text;

                        string ccc = "powershell -command " + label2.Text + "winget install --accept-package-agreements --accept-source-agreements --silent --source " + sourcename + " " + zzz + label2.Text;
